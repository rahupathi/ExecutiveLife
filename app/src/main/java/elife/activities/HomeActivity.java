...
protected void onCreate(Bundle savedInstanceState) 
{
    ...
    getWindow().setFeatureDrawableResource(Window.FEATURE_LEFT_ICON, R.drawable.ic_elife_launcher);
    ...
    /*
	findViewById(R.id.home_btn_feature1).setOnClickListener(new View.OnClickListener() {
        @Override
    ...
    findViewById(R.id.home_btn_feature2).setOnClickListener(new View.OnClickListener() {
        @Override
        public void onClick(View view) {
        	Intent i = new Intent(HomeActivity.this,MemberInfoListActivity.class);
            startActivity(i);
        }
    });
    */
