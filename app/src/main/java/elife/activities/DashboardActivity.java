...
public void onClickFeature (View v)
{
    ...
    switch (id) {
      case R.id.home_btn_feature1 :
    	   startActivity (new Intent(getApplicationContext(), UnitListActivity.class));
    	   break;
      ...
      case R.id.home_btn_feature5 :
    	  ...
    	  Toast.makeText(DashboardActivity.this, "Under Construction", Toast.LENGTH_LONG).show();
           break;
      case R.id.home_btn_feature6 :
    	  
    	  final Builder builder = new Builder(this);
    	    builder.setTitle("ExecutiveLife");
